...
const schemaFiles = [
  ...
  'evidence', 'artifact', 'approval', 'checkpoint', 'deployment-profile', 'discovery-manifest', 'model-endpoint', 'model-request', 'model-response', 'adapter-endpoint', 'browser-endpoint', 'browser-action-batch'
] as const;
