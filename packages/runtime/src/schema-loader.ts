...
const schemaFiles = [
  ...
  'evidence', 'artifact', 'approval', 'checkpoint', 'audit-receipt', 'deployment-profile', 'discovery-manifest', 'model-endpoint', 'model-request', 'model-response', 'adapter-endpoint', 'browser-endpoint', 'browser-action-batch', 'desktop-endpoint', 'desktop-action-batch',
  'execution-binding', 'team-plan', 'work-assignment', 'programme-proposal', 'supervision-policy', 'supervision-cycle'
] as const;
